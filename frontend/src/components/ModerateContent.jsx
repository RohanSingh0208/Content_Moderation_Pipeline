    ...
    <div className="animate-fade-in" style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column' }}>
      ...
      <div className="page-header" style={{ marginBottom: '2rem' }}>
        <div>
          ...
          <div className="page-subtitle">Run AI classification against your active policy</div>
        </div>
      ...
      <div className="card" style={{ marginBottom: '1.5rem' }}>
        <div className="form-group">
          <label className="form-label" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <span style={{color: 'var(--text-secondary)'}}>{content.length} / 2000</span>
          </label>
          <textarea 
        ...
        <div style={{display: 'flex', gap: '1.5rem', marginBottom: '1.5rem'}}>
          <div style={{flex: 1, display: 'flex', flexDirection: 'column', gap: '0.5rem'}}>
            <label style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', fontSize: '0.9rem', fontWeight: 500, color: 'var(--text-primary)' }}>
        ...
        <div style={{display: 'flex', gap: '1rem'}}>
          ...
          >
            <ShieldCheck size={18} /> {loading ? 'Running...' : 'Run moderation'}
          </button>
          <button 
        ...
        {error && (
          <div style={{marginTop: '1rem', color: 'white', padding: '1rem', backgroundColor: 'var(--danger)', borderRadius: '6px', whiteSpace: 'pre-wrap', wordBreak: 'break-word'}}>
      ...
      {!result && (
        <div className="info-cards-grid">
          ...
          <div className="info-card">
            ...
            <div className="info-card-value">{queueCount !== undefined ? queueCount : 0} items</div>
          </div>
          <div className="info-card">
